...
janusgraph_server_csv_metrics_dir = config['configurations']['janusgraph-env']['janusgraph_server_csv_metrics_dir']
janusgraph_server_csv_metrics = config['configurations']['janusgraph-env']['janusgraph_server_csv_metrics_dir'] + \
                                      '/' + config['configurations']['janusgraph-env']['janusgraph_server_csv_metrics_name']
storage_hbase_table= config['configurations']['janusgraph-env']['storage_hbase_table']
